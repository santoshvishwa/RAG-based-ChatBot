...
st.set_page_config(
    page_title="Talk2YourData - Document Assistant Chatbot",
    page_icon="🗃️",
    layout="wide",
...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">🗃️ Talk2YourData </h1>
...
with st.sidebar:
    ...
    st.markdown("Upload your Pdf documents to start chatting!")
    ...
    if uploaded_files:
        ...
        if st.button("🚀 Process Documents", type="primary"):
            with st.spinner("Processing your Pdfs documents..."):
...
# Main chat interface
st.markdown("### 💬 Chat with Your Own Documents")
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                system_prompt = f"""You are Talk2YourData, an intelligent medical document assistant. 
...
<div style="text-align: center; color: #666; font-size: 0.9rem;">
    <p>🤖 Powered by Euri AI & LangChain | 🏥 Document Intelligence Chatbot</p>
</div>
""", unsafe_allow_html=True)    
